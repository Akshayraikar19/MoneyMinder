...
// //             } finally {
// //                 setLoading(false); // Set loading to false once loan details are fetched
// //             }
// //         };
// //         fetchLoanDetails();
// //     }, [id]);
...
// //                     setHasApplied(true);
// //                     setApplication(response.data.application); // Set application details if applied
// //                     // Set rejected reason if application status is 'rejected'
...
// //             } finally {
// //                 setLoading(false); // Set loading to false after checking application status
// //             }
// //         };
// //         if (user) {
// //             checkApplicationStatus();
// //         } else {
// //             setLoading(false); // If user is not logged in, set loading to false
// //         }
// //     }, [id, user]);
...
// //                 }
// //             });
// //             console.log("Check status response:", response.data); // Debugging: Log response data
// //             if (response.data) {
...
// //                                                                 {/* Display additional details for rejected applications */}
// //                                                             </div>
// //                                                         )}
...
// //                                                     <button className="btn btn-outline-primary mt-3" onClick={handleCheckStatus}>
// //                                                         Check Application Status
// //                                                     </button>
// //                                                 )}
// //                                             </div>
// //                                         ) : (
// //                                             <button className="btn btn-primary mt-3" onClick={handleApply} disabled={!user || loading}>
// //                                                 Apply Now
// //                                             </button>
// //                                         )
// //                                     ) : (
// //                                         <p className="card-text text-danger mt-3">You do not have permission to apply for this loan.</p>
// //                                     )
// //                                 ) : (
// //                                     <p className="card-text mt-3">Sign in to apply for the loan</p>
// //                                 )}
// //                             </div>
// //                         </div>
// //                     ) : (
