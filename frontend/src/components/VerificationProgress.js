...
import verificationBackground from  '../assets/images/bg4.jpg'; // Update the path to your image
      ...
      <Container>
        <Row className="justify-content-center">
          <Col xs="10" md="8" lg="6" className="text-center">
            ...
            <p className="lead">Your account is currently under verification please wait until admin verifies. Thank you for your patience!</p>
            <div className="mt-4">
